...
public:
  enum {
    ...
    T__32 = 33, COMMENT = 34, MULTICOMMENT = 35, INT = 36, ID = 37, WS = 38, 
    STR = 39
  };

  enum {
    RuleProgram = 0, RuleTopDef = 1, RuleArg = 2, RuleBlock = 3, RuleStmt = 4, 
    RuleType_ = 5, RuleItem = 6, RuleExpr = 7, RuleAddOp = 8, RuleMulOp = 9, 
    RuleRelOp = 10
  };
